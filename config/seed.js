...

    {
        ...
        story: {
            stories: [
                {
                    section: "Character Details",
                    excerpt: "A sprited and quirky young girl who is into all the things girls her age are interested in, such as taking photos.\nShe was awakened from a piece of drifting eternal ice, only to find that she knows nothing about herself or her past.\nThough initially feeling dejected, she decided to name herself after the date of her rebirth\nAnd thus, on that day, March 7th was born."
                },
                {
                    section: "Character Story: Part 1",
                    excerpt: "Why does March 7th take photos?\n'First of all, girls like me should like this kind of pastime.'\n'Besides, I won't forget anything that I keep a photo of.\n\nWhat has March 7th come to learn about photography?\n'Number one, when taking pictures of terrible cuisines, all the details must be clearly visible on the pictures\nbecause taking pictures of food is equal to eating them. Every detail matters.'\n'Number two, as long as you take a picture with your eyes closed,\nyou will be able to capture an expression of your subject with their eyes closed.'\n\nWhy is March 7th always wearing her camera?\n'Because if anyone ever seals me away in ice again, at least I'll have my camera with me!'\n\nSo why doesn't March 7th just use the camera on her phone?\n'Oh yeah, why not - hang on, it's because of that sense of formality!"
                },
                {
                    section: "Character Story: Part 2",
                    excerpt: "March 7th's ability is 'Six-Phased Ice,' but she always insisted that it is not ice but some kind of condensed crystal.\n'Come in, ice can't be this beautiful.'\n\nThe bows and arrows that March 7th uses in battle are also made of the Six-Phased Ice,\nbut she is not satisfied with the fact that her weapon is a bow.\n'Great warriors never use bows!'\n'Besides, if I use my ice arrow to attack my ice shield, nothing will happen at all!'\n\nMarch 7th has also worked hard to practice a unique skill called 'Star Crazing: Glass Greatsword,' but she never succeeded.\n'March, juding by the name, it should be a greatsword, right?'\n'Well, but it doesn't feel as good as an ice sculpture... smash."
                },
                {
                    section: "Character Story: Part 3",
                    excerpt: "Compared to Pom-Pom the conductor, Himeko the Navigator, Dan Heng the Guard, and Welt the Jack-of-all-Trades,\neven March 7th has ahard time explaining her role aboard the Express despite calling herself a 'Warrior.'\nBut March 7th's every move affects the crew's course of action all the time.\n\n'Passenger March 7th slipped and fell...'\n'March, have you taken pictures of the sights over there?'\n'I believe March. If she said it's not delicious, then it's truly not delectable.'\n\nRather than calling March 7th someone who constantly wories people, it would be better to say that she works her way into people's hearts.\nMarch 7th, of course, is oblivious to this, and is struggling to think up the right role for The Trailblazer."
                },
                {
                    section: "Character Story: Part 4",
                    excerpt: "For March 7th, who has been drifting in space, the situation in which she awoke isn't too bad.\nShe woke up on a passing train, and the people on the train looked friendly.\nThe only problem is that even though she has a reasonable understanding of what's going on around her,\nshe still doesn't know anything about herself.\n\n'Who am I? Where do I come from...'\n\nMarch 7th looks at herself in the mirror, imagining dozens of potential past lives for herself\nas she tries on the various outfits that Hiemko had assembled for her.\nBut she can't be sure what her past was like, and what kind of past a girl like her should have...\nThe only thing March 7th can choose to be is her current self, and the only thing she can look forward to is the future.\nShe is both fightened and glad."
                },
            ]
        },
        traces: {
...

    {
        ...
        story: {
            stories: [
                {
                    section: "Character Details",
                    excerpt: "A cold and reserved young man who wields a spear known as Cloud-Piercer. He acts as the Express' guard on its long trailblazing expedition.\nDan Heng never talks much about his past. In fact, he joined the Express Crew to escape from a past of his own making.\nBut can the Express really help him outrun his past?"
                },
                {
                    section: "Character Story: Part 1",
                    excerpt: "A new dawn begins\n\nIt's just another extremely average day aboard this giant ship. The markets have just opened and the morning dew is still fresh,\nbut the youngman crossing the street has never seen such a sight.\nBefore he manages to notice all the differences between the actual city and its descriptions in books,\nhe is immersed in savoring the warmth of the sun on the back of his neck.\n\nIt is his first time seeing his own body clearly. This body belongs to him. It belongs to this current name.\n\nWhen he arrives at the port, the escorting soldier removes the last of his shackles. He wealks forward without looking back.\nHe can feel, ever so faintly, several pairs of eyes gazing at him from within the city. Eyes filled with hatred.\n\nIt isn't until the spaceship takes off that he turns his head and takes one final look at this place.\nIt really is magnificent and grand spaceship - just like the books say.\n\nHe only glances at it once, then turns his head away to where the stars shimmer dimly and an uncertain future lies\n\nHe looks out in silence."
                },
                {
                    section: "Character Story: Part 2",
                    excerpt: "A new dawn begins.\n\nHe steps off one IPC spaceship then boards another. He'd never even heard of the ship's destination, but that doesn't matter.\nThere is nowhere he particularly wanted to go. His only goal is to get as far away as possible from his past, from his 'home.'\n\nOn these spaceships, people come and go all the time. None of the IPC crews care who he is, so long as he can work.\n\nHe has changed his appearance and might no longer be recognized, but he knows that same power still lurks within him,\nunable to be shaken off no matter where he goes. This power drags him down, slows him, tries to overwhelm him,\nand makes him unable to escape his past. He has to be careful.\n\nBut he still can't shake off the man with the beastly eyes.\n\nIf others in his homeworld felt hatred toward him, then that man only has a killing intent toward him -\neven the spaceships he had traveled on were all annihilated. That man had died before him, but would reappear soon after.\n\nOutside his homeworld, there's a larger world where anything is possible."
                },
                {
                    section: "Character Story: Part 3",
                    excerpt: "A new dawn begins.\n\nHe boards another spaceship, and the passengers are all wearing different masks.\nHe nearly has his memory stolen, and is forced to listen to a lecture that sounded like mad ramblings.\n\nHe knows that huge monsters prowl upon this route, but he could only find a way toward survival by traveling along the most dangerous of roads.\n\nHe defeats the huge monsters and disembarks at the next port. He thinks he could remain undetected among the countless ships,\nbut he is stopped by a redhead woman. She salutes him in thanks, saying she is with one of the ships he had rescued.\n\nHe is about to turn and leave when he sees a parked train besides the redhead woman.\n\n'Where's your next stop?'\n'...Haven't decided yet.'\n'Then would you like to board our Express?'\n'...'\n'We're retracing our previous journey. There's so much to see all over again. We need a guard... And an archiver.'\n'...'\n'You can get off any time once you made up your mind on where to go.'\n'Alright.'"
                },
                {
                    section: "Character Story: Part 4",
                    excerpt: "A new dawn begins.\n\nHe rubs his eyes, realizing it had been too long since he had such a good night's sleep.\nHe considers himself as only staying temporarily and refused the room specially prepared for him, making a simple bed on the floor of the Archives.\nHowever, he stayed up all night reading the data bank. At some point, he'd drifted off to sleep.\n\nHe opened the door to find the conductor standing there, reprimanding him for staying up late —\nOtherwise he'd miss out on a piping hot breakfast and would've wasted the care put into it.\nHe nods and the conductor quietens down in satisfaction, wobbling as they lead him into the passenger car.\n\nThe redhead woman — who he now knows is named Himeko — flashes him a smile. The brunet man to the other side — Mr. Yang —\nremains silent despite appearing to have many questions on his mind.\n\nBefore he knew it, he'd spent many a morning just like this.\n\nThe process of re-visiting the route is not easy, mostly due to the numerous roadblocks caused by Stellaron.\nSometimes, they would encounter the huge monsters he'd defeated before.\nThey even found an enormous chunk of floating ice — encased in which was a living girl.\n\nThat's why he wasn't very surprised when he detected that the (boy/girl) named Trailblazer has an actual Stellaron sealed inside his/her body.\n\nThe Express's journey will continue on. Is there anything beyond the realm of possibility?"
                },
            ]
        },
        traces: {
...

    {
        ...
        story: {
            stories: [
                {
                    section: "Character Details",
                    excerpt: "An adventurous scientist encountered the Astral Express as a young woman when it got stranded in her homeworld.\nYears later, when Himeko finally repaired the Express and began her journey into the stars, she realized that this is only the beginning.\nOn her journey to trailblaze new worlds, she would need many more companions...\nAnd while they may have different destinations, they all gaze at the same starry sky."
                },
                {
                    section: "Character Story: Part 1",
                    excerpt: "The girl is lost.\n\nShe can't remember when she became lost. She just walked and walked, on and on into the dark night,\nchasing the sun and the moon, over and over again - until she falls.\n\nShe remembers what she looked like as a college freshman, remembers her chosen major -\nintersterllar travel dynamics - and now she's lying face down in the mud.\n\nShe looks up to the stars, and just then sees meteors streaming down: One, two, three...\nAnd then more, smaller ones, flickering and flashing ever so finely before the magnificent blaze tore open the night.\n\nHer limbs drag her forward, leading her on to where the land meets the ocean.\nAt the shoreline, the waters jostle against her like how the tide treats that stranded Express, alone and lost.\n\nShe walks in and see the scenery outside beginning to change. The Express shows her a myriad of magnificent worlds.\nThey are faraway, beyond her homeworld, yet also close enough to be a simple train ride.\n\nShe tries to repair the Express. It starts up only briefly, but it is enough to skid across the sky of her home.\nShe immediately sees the path home. From that altitude, the journey is so short, and even the ocean of her homeworld appears so insignificant.\n\nIt asked her whether she'd like to travel together. She wonders what kind of journey that would be.\n\n'A journey to the beginning.'\n\n'Lets go then.' Without hesitation, the girl replied, 'Just as you brought me home, so would I take you home, too.'"
                },
                {
                    section: "Character Story: Part 2",
                    excerpt: "Himeko has a suitcase.\n\nThis suitcase is her treasure trove. Previously, she'd filled it with all kinds of train repair tools to fix up the Express.\nBut now, it's packed with a molecular saw, an escaped satellite,\nand countless other contraptions - the embodiment of her whims and the proof of her resolute will.\n\nNo travel companion is more faithful to her than this suitcase. Passengers come and go on the Express,\nand perhaps not even 'the conductor' would be able to accompany her and the Express from start to finish.\n\nBut she doesn't care. She didn't care when that pretentious blond man left without saying goodbye,\njust like how she didn't care about her distant homeworld and old fiends.\n\nShe knows that this journey is lonely. Even if she could get to know like-minded travel companions,\neven if they showed her generous grace, even if she could witness the end of a complete journey with those companions -\nthat's all just a momentary fluke.\n\nShe knows that this journey is lonely. Nobody can follow in the exact same footsteps as anyone else.\nNobody can experience for someone else everything that happens along a journey.\n\nAll she can rely on are her own two eyes and feet."
                },
                {
                    section: "Character Story: Part 3",
                    excerpt: "Himeko's memory is very good.\n\nThe longer the journey gets, the more travel companions she accrues. She can still remember many of them.\n\nShe remembers her awkward chit-chats with Pom-Pom, and how the first two passengers aboard the Express were Welt and his Blond friend.\n\nShe remembers how the taciturn Dan Heng defeated the monsters that can swallow stars with just one strike of his lance.\n\nShe remembers how March 7th had awoken from her icy sulmber, all the outfits she'd designed for March, and what March loves the most.\n\nShe remember how the Crew arrived at Herta Space Station, how she met Trailblazer, and how they'd embarked on a new journey once more.\n\nShe remembers the specifications for every single component of the Express and how they're assembled.\n\nShe remembers when to oil the Express' bearings and when each plant on the Express needs watering.\n\nShe remembers Pom-Pom's non-negotiable bottom line, and that Welt has rather juvenile hobbies.\n\nShe remembers that Dan Heng is always pulling all nighters to organize the data bank, and how March 7th loves to sleep in.\n\nShe remembers the personality, habits, hobbies, birthdays, and other anniversary days of everyone aboard the Express.\n\nAnd she remembers much, much more.\n\nThe greatest pleasure for Himeko is that everyone can safely reach their destination on the Express.\n\n'Traveling always has an endpoint. When it happens, I'll smile and say goodbye to everyone.'\n\nIt's memory that has formed the road she came from, and memory that will eventually return her to the seas on whence she came."
                },
                {
                    section: "Character Story: Part 4",
                    excerpt: "'What a long journey.' She says.\n\n'I've been waiting for so, so long. |REDACTED| looks at her: 'It wasn't bad luck that has led you down this path, but wanderlust and curiosity'\n\n'Of course,' she smiles, 'But I've experienced far less than what you've been through.'\n\n'No, I've never experienced the things you have.' |REDACTED| shakes their head:'There are as many routes as there are pairs of feet.'\n\n'Right now, we may be standing in the same place, but we harbor different thoughts and views.'\n\nTogether, they look up to the stars in silence, and just then saw meteors streaming down: One, two, three...\n\nAnd then more, smaller ones, flickering and flashing ever so finely before a magnificent blaze tore open the night.\n\nA quiet voice disturbs the still air once more:'What do you see?'\n\n'The stars have finished their journey.' She says.\n\n|REDACTED| laughs: 'I, instead, see that their journey is only just beginning.'\n\nThey do not speak again.\n\n'Lets go back. they're waiting for me.'"
                },
            ]
        },
        traces: {
...

    {
        ...
        story: {
            stories: [
                {
                    section: "Character Details",
                    excerpt: "The wise and sophisticated former Anti-Entropy Sovereign who inherits the name of the world - Welt.\n\nHe has saved Earth from annihilation time and time again.\n\nAfter the incident with St. Fountain came to a close, Welt had no choice but to venture with the initiator of the incident to the other side of the portal.\n\nPerhaps even he didn't expect the new journey nor companions that awaited him there."
                },
                {
                    section: "Character Story: Part 1",
                    excerpt: "On the way to the portal, Welt took out a pen and started outlining a sketch. \n\nFor the eight years prior to that moment, he'd been repeating this job.\n\n Going back further in time, he would construct objects in a different way, as long as the images could be pictured in his mind.\n\nBut he could never regard that as 'creation,' because they were just the way the original is. Those had nothing to do with his mind.\n\nThis is just the duty of the man who inherited the name of the world.\n\nIf the world needs him to save it, then he will become that hero without hisitation.\n\nHe has fallen down many times and been mocked even more, but he will always stand before everyone either in the past or the future -\n\nhe will never change.\n\nOnly now, he finds himself embarking on a new journey."
                },
                {
                    section: "Character Story: Part 2",
                    excerpt: "When Welt returned to that dangerous cosmic battlefield, he could feel his blood start to boil once more.\n\nEven when his spaceship lost power and was drifting aimlessly through space, he joked casually with his companion:\n\n'The end of one adventure is often the beginning of another.'\n\nWhen a passing-by Himeko managed to save them and informed them that they couldn't go back home, he kept up his jokes:\n\n'This is like something out of a cartoon, and it's far too coincidental to be real.'\n\nLife really is that coincidental.\n\nSince he can't find his way back home and can't live out a peaceful existence for the time being, why doesn't he take up arms again and fight?\n\nThis time, there is no burden or destiny to bear. Everything shall obey his own will."
                },
                {
                    section: "Character Story: Part 3",
                    excerpt: "These days, Welt rarely fights, and it remains unknown whether or not he retains the strength from his heyday.\n\nGravity manipulation has remained his usual combat means, ever since his cane was transformed from the Star of Eden.\n\nHe suppresses his enemies with gravity, even creating a kind of mini-black hole -\nwhat he considered his everyday powers are met with amazement by the youngsters of the Express.\n\n'Mr. Yang's incredible, amazing!'\n'If you need help with anything, Trailblazer, go ask Mr. Yang.'\n'You need to take turns. Let him rest a little while...'\n\nHe is shocked to realize that his carelessness and surety are the results of his countless experiences,\nmarks of the relentless passage of time he had endured.\n\nHowever, the youths aboard the Express are like blank pieces of paper, writing out their own lives.\n\nWhat kind of responsiblities should he take on in their lives?\n\nHe couldn't help but think of the names of people throughout his life who had helped him before."
                },
                {
                    section: "Character Story: Part 4",
                    excerpt: "- Welt's Log |DATE|/|DATE|/|DATE|\n\n|REDACTED|'s relationship with the protagonists:\n\n|REDACTED|-|REDACTED|'s sparkling personality is just like the protagonist in a cartoon. Go for it!\n\n|REDACTED| - A lively youth. I hope she can keep being imaginative, and not feel guilty even if she stumbles.\nYouths are always going to make mistakes, and |REDACTED| will be able to support her.\n\n|REDACTED| - A reliable youth. There's no need to worry about him.\nI hope he can chat more with |REDACTED|, but if he doesn't want to, then that's fine.\n\n|REDACTED| - I can trust this companion with my life,|REDACTED| believes she will make the right decision.\n\n||REDACTED| - A common character in cartoons.\nSeemingly just a normal creature, but actually possesses frighteningly powerful abilities and a complicated background.\n\nNote: If I ever get back home, consider making a cartoon out of this."
                },
            ]
        },
        traces: {
